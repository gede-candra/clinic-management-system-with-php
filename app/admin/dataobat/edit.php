...
<div class="bg-white w-full p-8 rounded-md shadow flex flex-col items-center">
    <form action="" method="post" class="flex flex-col gap-8 text-sm w-full    lg:w-2/3">
      <div class="w-full"><input type="text" class="p-2 w-full outline-none border-b-2" placeholder="Nama Obat"></div>
      <div class="w-full"><input type="number" class="p-2 w-full outline-none border-b-2" placeholder="Jumlah Obat"></div>
      <div class="w-full">
